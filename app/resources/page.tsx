  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start pt-24 p-4 lg:p-24 gap-20">
      ...
      <div className="flex flex-col max-w-5xl w-full items-start lg:ml-40 gap-10">
        ...
        <p>
          <strong>
            Disclaimer: Use of Analytical Chemistry Data for Psilocybe Mushroom
            Samples
          </strong>
        </p>
        ...
        <ol className="flex flex-col gap-10">
          ...
          <li>
            ...
            applicable local, state, and federal laws. The legality of Psilocybe
            mushrooms varies widely by jurisdiction, and you are solely
            responsible for understanding and adhering to the laws in your area.
          </li>
          ...
          <li>
            ...
            caution, responsibility, and moderation in any activities related to
            Psilocybe mushrooms.
          </li>

          <li>
            <strong>Accuracy of Information:</strong> While we strive to provide
            accurate and reliable analytical chemistry data, we cannot guarantee
            the accuracy, completeness, or up-to-date nature of the information
            presented on this website. Users should independently verify any
            data or information for their specific purposes.
          </li>
          ...
          <li>
            ...
            consequences resulting from your use of the information provided on
            this website.
          </li>
          ...
          <li>
            ...
            must confirm that they meet the legal age requirement for accessing
            and using this website.
          </li>
        </ol>

        <p>
          By using TrypReports, you acknowledge that you have read, understood,
          and agreed to the terms of this liability notice. Your use of the
          website signifies your acceptance of these terms and your commitment
          to using the information provided responsibly and legally.
        </p>

        <p>
          If you do not agree with any part of this notice, please refrain from
          using this website.
        </p>
        ...
        <p>
          Thank you for your understanding and responsible use of our resources.
        </p>
